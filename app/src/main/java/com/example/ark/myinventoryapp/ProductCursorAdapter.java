...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        int discountColumnIndex=cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_DISCOUNT_NBR);
        ...
        Integer productDiscount = cursor.getInt(discountColumnIndex);
